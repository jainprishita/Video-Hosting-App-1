...
public class AdminService {
    ...
    public VideoEntity getVideo(final String videoUuid, final String authorization) throws VideoNotFoundException, UnauthorizedException, UserNotSignedInException {
        ...
        if(userAuthTokenEntity==null)
           throw new UserNotSignedInException("ATH-005", "User not found");
        if(videoDao.getVideo(videoUuid)==null)
            throw new UserNotSignedInException("VTH-001", "Video not found");

        return videoDao.getVideo(videoUuid);
